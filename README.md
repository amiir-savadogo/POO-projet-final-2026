...
## Noms en français (avant → après)
| Anglais (avant)    | Français (maintenant)    |
|--------------------|--------------------------|
| Dataset            | JeuDonnees               |
| data / donnees     | donnees                  |
| columns            | colonnes                 |
| fit / predict      | executer / predire       |
| results            | resultats                |
| heatmap            | carte_chaleur            |
| scatter            | nuage_points             |
| boxplot            | boite_moustaches         |
| violin             | violon                   |
| bubble chart       | graphique_bulles         |
| pairplot           | matrice_dispersion       |
| clustering         | partitionnement          |
| PCA                | ACP                      |
| random forest      | foret_aleatoire          |
| skewness           | asymetrie                |
| kurtosis           | aplatissement            |
| outliers           | valeurs_aberrantes       |
| threshold          | seuil                    |
| label              | etiquette                |
| scaler             | normaliseur              |
